...
import io.github.auditlistener.service.ElasticSearchServiceImpl;
import io.github.auditlistener.service.EventListenerImpl;
import io.github.auditlistener.service.KafkaServiceImpl;
    ...
    void processValidMethodData_Success() throws Exception {
        ...
        await().atMost(15, TimeUnit.SECONDS)
                ...
                .untilAsserted(() -> {
                    ...
                    assertEquals("TestService.testMethod", document.getMethodName());
